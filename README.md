...
Been developed to break Entry Point in almost every way you can imagine.
## Usage
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Hdfoweutgut/VulnerablePoint/main/VPLUA'))()
```
